...
type RawFontData = Omit<FontDefinition, 'characters'> & { characters?: Record<string, number[][]> };

const fonts: Record<FontFamilyName, RawFontData> = {
  [FontFamilyName.A]: {
    name: 'FONT_A',
    spacing: { right: 2, left: 0, top: 0, bottom: 0 },
    size: { width: 7, height: 12 },
    base64: {
      '0': 'efs379meGAAAAA==', '1': '4cGDBgw+AAAAAA==', '2': '+fgwwww/AAAAAA==',
      '3': '+fhzwcG+GAAAAA==', '4': 'GHHjz9+GAAAAAA==', '5': 'ePHDwMO+OAAAAA==',
      '6': 'ePPn7NmfGAAAAA==', '7': '/fhgwwYYAAAAAA==', '8': 'efszz9m/GAAAAA==',
      '9': 'efs358OeGAAAAA==', ' ': 'AAAAAAAAAAAAAA==', 'A': 'MPHjz9+zAAAAAA==',
      'B': '+fs3zNm/AAAAAA==', 'C': 'fPsGDByfDAAAAA==', 'D': '+fM2bNu+AAAAAA==',
      'E': '+fIHyBA+AAAAAA==', 'F': '+fMHzBgwAAAAAA==', 'G': 'ffsG7d2fGAAAAA==',
      'H': 'zZs37NmzAAAAAA==', 'I': '8eGDBgw8AAAAAA==', 'J': 'ePBgwZM+MAAAAA==',
      'K': 'zbvnj5uzAAAAAA==', 'L': 'gQIECBA+AAAAAA==', 'M': 'zfv379mzAAAAAA==',
      'N': '7du379u3AAAAAA==', 'O': 'efs2bNmeGAAAAA==', 'P': '8fJnzxAgAAAAAA==',
      'Q': 'efs2bNmeHAgAAA==', 'R': '+fs3z5mzAAAAAA==', 'S': 'efMHwdG/GAAAAA==',
      'T': '/fjBgwYMAAAAAA==', 'U': 'zZs2bNmeGAAAAA==', 'V': 'zZszx48MAAAAAA==',
      'W': 'hZv379+fAAAAAA==', 'X': 'zfnhh5+zAAAAAA==', 'Y': 'zfnjwwYMAAAAAA==',
      'Z': '/fhhxww/AAAAAA==', 'a': 'AAHj79u/EAAAAA==', 'b': 'wYPnbN2+GAAAAA==',
      'c': 'AAPmSBk+GAAAAA==', 'd': 'DBn27NufGAAAAA==', 'e': 'AAHmb9gfGAAAAA==',
      'f': 'eMPjBgwYAAAAAA==', 'g': 'AAH27NufDHgAAA==', 'h': 'gQPGyZMmAAAAAA==',
      'i': 'MGHBgwY/AAAAAA==', 'j': 'MGHBgwYMGPAAAA==', 'k': 'wYPnjx42AAAAAA==',
      'l': '8GDBgwYOAAAAAA==', 'm': 'AAP379+/AAAAAA==', 'n': 'AAPGyZMmAAAAAA==',
      'o': 'AAHmbNmeGAAAAA==', 'p': 'AAPnbN2+eMAAAA==', 'q': 'AAH27NmfHgwAAA==',
      'r': 'AAPnDBgwAAAAAA==', 's': 'AAPGDwY8MAAAAA==', 't': 'IEPhAgQOAAAAAA==',
      'u': 'AAJkyZM+IAAAAA==', 'v': 'AAM3548MAAAAAA==', 'w': 'AAM379+eAAAAAA==',
      'x': 'AAPzww8/AAAAAA==', 'y': 'AAMz548MGOAAAA==', 'z': 'AAPhhhg+AAAAAA==',
      '`': 'wcGAAAAAAAAAAA==', '!': 'AYMGDBgwYAAAAA==', '@': 'AGH279Svfnh4AA==',
      '#': 'AHj355+/eAAAAA==', '$': 'AGHnx4+/fjBgAA==', '%': 'AMPHr9+NHgAAAA==',
      '&': 'APHjD1+3fjAAAA==', '(': 'AMMGDBgwYODAAA==', ')': 'AYGDBgwYMOGAAA==',
      '{': 'AOGDBhwYMHBgAA==', '}': 'AcGDBg4YMOGAAA==', '[': 'AcMGDBgwYOHAAA==',
      ']': 'AcGDBgwYMOHAAA==', '_': 'AAAAAAAAAAH78A==', '+': 'AADBj9+MGAAAAA==',
      '-': 'AAAAAB4AAAAAAA==', '*': 'AGPzx8YAAAAAAA==', '/': 'ABhgwwYYMMAAAA==',
      ':': 'AAAGDAAwYAAAAA==', ',': 'AAAAAAAwYMEAAA==', '.': 'AAAAAAAwYAAAAA==',
      '?': 'AePhhwwYMAAAAA==', ';': 'AAAGDAAwYMEAAA==', '\'': 'AYMGAAAAAAAAAA==',
      '"': 'AbNmwAAAAAAAAA=='
    }
  },
  [FontFamilyName.B]: {
    ...
    base64: {
      '0': 'OB8P4xjGP4/z+MYxjuHwOAAAAAAAA===', '1': 'AD4PgGAYBgGAYBgGB+H4AAAAAAAAA===',
      '2': 'MD8P4BgGA4HA8HgcD+P4AAAAAAAAA===', '3': 'MD8P4BgOH4fAOAYBj+P4eAAAAAAAA===',
      '4': 'AAOA4Hg+DYdjmP+/4GAYAAAAAAAAA===', '5': 'AD8PwwD4Pw/gGAYBj+PweAAAAAAAA===',
      '6': 'GB+P44D4P47jGMcxjuH4OAAAAAAAA===', '7': 'AD+P4DgMBwHAYDgMBwHAAAAAAAAAA===',
      '8': 'OD+O4xjGP4/juMcxzuP4OAAAAAAAA===', '9': 'HB+H8YzjGMdx/D8Ax/H4OAAAAAAAA===',
      ' ': 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAA===', 'A': 'AAcBwPg2DYdx3H8/7jsGAAAAAAAAA===',
      'B': 'AD+P4xjGP4/jHMcxz/P4AAAAAAAAA===', 'C': 'HB+P44DAMAwDAMA4D2H4HAAAAAAAA===',
      'D': 'AD8P4zjGMcxzHMYzj+PwAAAAAAAAA===', 'E': 'AD+P4wDAP4/jAMAwD/P8AAAAAAAAA===',
      'F': 'AD/P84DgP4/jgOA4DgOAAAAAAAAAA===', 'G': 'DA/H8YDgOA57nuOY5/j8DgAAAAAAA===',
      '#': 'AAbBsGz/v+Nj/P+bBsGwAAAAAAAAA===', '$': 'GAYH4/jYPg/B+B8Hz+P4GAYBgAAAA===',
      '%': 'ABwPg2DYv+fz/O+DYNg+AAAAAAAAA===', '&': 'HA+HYcBwHgfb9s+x73n+HAAAAAAAA===',
      '(': 'MBwGA4DAMAwDAMAwDgOAYBwAAAAAA===', ')': 'wDgGAcAwDAMAwDAMBwHAYDgAAAAAA===',
      '{': 'DgeDgOA4DgeDwHgOA4DgOAeB4AAAA===', '}': '8DwDgOA4DgPAeDwOA4DgODwPAAAAA===',
      '[': '8DwMAwDAMAwDAMAwDAMA8DwAAAAAA===', ']': '8DwDAMAwDAMAwDAMAwDA8DwAAAAAA===',
      '_': 'AAAAAAAAAAAAAAAAAAAAAAAAA/4AA===', '+': 'AAAAAHAcBw/7/hwHAcBwAAAAAAAAA===',
      '-': 'AAAAAAAAAAAD4PgAAAAAAAAAAAAAA===', '*': 'EAQNY/h8P41gQAAAAAAAAAAAAAAAA===',
      '/': 'AADAcBgOAwHAYDgOBwHAYDgAAAAAA===', ':': 'AAAAAADgOA4AAAA4DgOAAAAAAAAAA===',
      ',': 'AAAAAAAAAAAAAAA4DgOA4DAIAAAAA===', '.': 'AAAAAAAAAAAAAAA4DgOAAAAAAAAAA===',
      '?': 'OD+P4BgOBwOA4DAMAwDAAAAAAAAAA===', ';': 'AAAAAADgOA4AAAA4DgOA4DAIAAAAA===',
      '\'': 'ADgOA4DgEAAAAAAAAAAAAAAAAAAAA===', '"': 'ADuO47juAAAAAAAAAAAAAAAAAAAAA==='
    }
  },
  [FontFamilyName.D]: {
    name: 'FONT_D',
  ...
  [FontFamilyName.E]: {
    ...
    base64: {
      ...
      'm': 'AAAAAAAAAAAAAAAAAAAAAAAAAABvHg//+P//z//8///Pnz758+8fPvHj7x4+8ePvHj7x4+8ePvHj7x4+8ePODhwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',
  ...
  [FontFamilyName.F]: {
    ...
    base64: {
      ...
      'g': 'AAAAAAAAAAAAAAYAH/g/+H34eHjwePA48DjwOPA48DhwOHh4fPg/+B/4BjgAOCB4P/A=',
...
export function initialize(): void {
  for (const fontKey of Object.values(FontFamilyName)) {
    const font = fonts[fontKey];
    if (!font.spacing) continue;

    font.characters = {};
    for (const charKey in font.base64) {
      const blocks = decode(font.base64[charKey]);
      font.characters[charKey] = [];

      for (let y = 0; y < font.size.height; y++) {
        font.characters[charKey][y] = [];
        for (let x = 0; x < font.size.width; x++) {
          const index = (y * font.size.width) + x;
          font.characters[charKey][y].push(blocks[index]);
        }
      }
    }
  }
...
export default fonts as Record<string, FontDefinition>;
