const mapCode: Record<number, string> = {
  ...
  20: 'g', 40: 'h', 60: 'i', 80: 'j', 100: 'k', 120: 'l', 140: 'm', 160: 'n',
  180: 'o', 200: 'p', 220: 'q', 240: 'r', 260: 's', 280: 't', 300: 'u', 320: 'v',
  340: 'w', 360: 'x', 380: 'y', 400: 'z',
};

export function generateHexAscii(width: number, height: number, imageData: number[]): string {
  let index = 0;
  let bitIndex = 0;
  let output = '';
  let currentValue = 0;
